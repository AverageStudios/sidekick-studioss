...
alter table public.workspace_provider_connections
  ...
  check (provider in ('meta', 'gohighlevel', 'hubspot', 'pipedrive', 'salesforce', 'zoho', 'freshsales', 'monday', 'keap', 'close', 'followupboss'));
...
alter table public.crm_routing_rules
  ...
  check (provider in ('gohighlevel', 'hubspot', 'pipedrive', 'salesforce', 'zoho', 'freshsales', 'monday', 'keap', 'close', 'followupboss'));
