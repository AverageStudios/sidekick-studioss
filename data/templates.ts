...
export const templateFallbackCatalog: TemplateSeed[] = [
  ...
  },
  {
    ...
    description: "A focused lead flow for detailers selling interior recovery, stain removal, and refresh jobs.",
  ...
  },
  {
    ...
    funnel: {
      ...
      whyChooseUs: [
        "Premium positioning without a bloated setup",
  ...
  },
  {
    ...
    description: "A recurring-revenue campaign for maintenance washes and simple monthly membership style offers.",
